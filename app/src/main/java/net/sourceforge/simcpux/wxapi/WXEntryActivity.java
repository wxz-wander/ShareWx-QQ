...
import com.wxz.share.wx.Constants;
import com.wxz.share.wx.GetFromWXActivity;
import com.wxz.share.R;
import com.wxz.share.wx.SendToWXActivity;
import com.wxz.share.wx.ShowFromWXActivity;
import com.wxz.share.wx.uikit.NetworkUtil;
...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: wx");
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.d(TAG, "onResume: wx");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.d(TAG, "onPause: wx");
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        setIntent(intent);
        api.handleIntent(intent, this);
        Log.d(TAG, "onNewIntent: wx");
    }

    @Override
    public void onReq(BaseReq req) {
        Log.d(TAG, "onReq: req:" + req.toString());
        switch (req.getType()) {
