...
public class BaseActivity extends Activity{
    ...
    protected void checkTencentInstance() {
        if (null == QQMainActivity.mTencent) {
            ...
            mEtAppid.setText(QQMainActivity.mAppid);
            final DialogInterface.OnClickListener mAppidCommitListener = new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    switch (which) {
                        case DialogInterface.BUTTON_POSITIVE:
                            ...
                            if (!TextUtils.isEmpty(editTextContent)) {
                                QQMainActivity.mAppid = editTextContent;
                            }
                            break;
                    ...
                    QQMainActivity.mTencent = Tencent.createInstance(QQMainActivity.mAppid, BaseActivity.this);
                }
            };
