...
import com.wxz.share.qq.ThreadManager;
...
//                }
    ...
    private void doShareToQzone(final Bundle params) {
        ...
        ThreadManager.getMainHandler().post(new Runnable() {
            ...
            @Override
            public void run() {
                if (null != QQMainActivity.mTencent) {
                    QQMainActivity.mTencent.shareToQzone(QZoneShareActivity.this, params, qZoneShareListener);
                }
            }
        });
    }
    ...
    private void doPublishToQzone(final Bundle params) {
        ThreadManager.getMainHandler().post(new Runnable() {
            ...
            public void run() {
                if (null != QQMainActivity.mTencent) {
                    QQMainActivity.mTencent.publishToQzone(QZoneShareActivity.this, params, qZoneShareListener);
                }
            }
        });
    }
