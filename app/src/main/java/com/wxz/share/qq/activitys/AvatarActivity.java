...
public class AvatarActivity extends BaseActivity implements OnClickListener {
    ...
    private void onClickSetAvatar() {
        if (QQMainActivity.ready(AvatarActivity.this)) {
    ...
    private void doSetAvatar(Uri uri) {
		...
		QQMainActivity.mTencent.setAvatar(this, params, new BaseUIListener(this));
    }

	private void doSetAvatar2(Uri uri) {
		QQMainActivity.mTencent.setAvatarByQQ(this, uri, new BaseUIListener(this));
	}

	private void doSetDynamicAvatar(Uri uri) {
		QQMainActivity.mTencent.setDynamicAvatar(this, uri, new BaseUIListener(this));
	}
