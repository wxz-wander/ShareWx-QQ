...
//		        finish();
		...
		subscribeMsgBtn.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				startActivity(new Intent(WXMainActivity.this, SubscribeMessageActivity.class));
//				finish();
			}
		});
        ...
        subscribeMiniProgramMsgBtn.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
                startActivity(new Intent(WXMainActivity.this, SubscribeMiniProgramMsgActivity.class));
			}
		});
		...
		jumpToOfflinePay.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
                ...
                if (wxSdkVersion >= Build.OFFLINE_PAY_SDK_INT) {
                    ...
                    Toast.makeText(WXMainActivity.this, "not supported", Toast.LENGTH_LONG).show();
                }
			}
		});
	}
		...
		switch (requestCode) {
			case Constants.PERMISSIONS_REQUEST_STORAGE: {
				if (grantResults.length > 0
					...
					Toast.makeText(WXMainActivity.this,"Please give me storage permission!",Toast.LENGTH_LONG).show();
				}
				return;
			}
		}
